...
% \footnote{\label{fnDFO2018}DFO. 2018. Evaluation of management procedures for Pacific Herring (\emph{Clupea pallasii}) in the Strait of Georgia and the West Coast of Vancouver Island management areas of British Columbia. DFO Can. Sci. Advis. Sec. Sci. Advis. Rep. (In press.)}
...
\subsection{Mandatory paragraph}
...
This Science Response Report results from the Science Response Process [meeting date and title (e.g., of \rdMonth{} \rdYear{} on the \rdTitle{})].
...
\subsubsection{Example citation, cross-references, and list}

This is a stock assessment \citep{ricker1954}.
This is our input data (\autoref{tabDataInput}), and this is our study area (\autoref{figBC}).
Input data has three main components:
\begin{resdoclist}
\item Catch data,
\item Biological data, and
\item Abundance data (i.e., the spawn index; \autoref{figSpawnIndex}).
\end{resdoclist}
\spawnIndex{}
\qPeriods{}
The spawn index is generally higher in the dive survey period (\autoref{tabMeanSpawn}).
